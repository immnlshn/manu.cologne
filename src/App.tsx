  ...
  return (
    <div className="relative">
      <motion.div style={{ y: glowY, opacity: glowOpacity }} className="pointer-events-none absolute inset-x-0 top-0 -z-10 overflow-hidden" aria-hidden>
        <div className="relative">
          <div className="absolute left-1/2 -top-[50rem] h-[120rem] w-[120rem] -translate-x-1/2 rounded-full bg-cyan-300/15 dark:bg-cyan-900/15 blur-3xl [mask-image:radial-gradient(closest-side,white_22%,transparent_72%)]" />
        </div>
      </motion.div>
